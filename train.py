...
def train(args, log_dir, hparams):
    ...
    if not GTA_state:
        ...
        input_path = os.path.join(
            'tacotron_' + args.output_dir, 'gta', 'map.txt')
...
def main():
    ...
    parser.add_argument('--tacotron_train_steps', type=int,
                        default=150000, help='total number of tacotron training steps')
    parser.add_argument('--wavenet_train_steps', type=int,
                        default=500000, help='total number of wavenet training steps')
